...
export default function AchievementsSection() {
  ...
  const achievements = [
    ...
    { id: "09", year: "Present", title: "One Star Export House", auth: "DGFT", image: "/dgft.jpeg" },
  ];
        ...
        <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6 md:gap-10 mb-8 md:mb-16 pt-12 md:pt-20">
          <div className="space-y-4 md:space-y-6 max-w-4xl">
            ...
            <div className="space-y-4 pt-4 border-l-4 border-gray-100 pl-6">
              ...
              <p className="text-gray-500 text-sm md:text-base font-medium leading-relaxed max-w-2xl">
                Furthermore, we are proudly <span className="text-gray-900 font-bold">Recognised by DGFT</span> (Director General of Foreign Trade, Government of India, Ministry of Commerce and Industry) as a One Star Export House.
              </p>
            </div>
          </div>
