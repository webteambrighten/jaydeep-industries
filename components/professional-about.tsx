  ...
  const phaseEvents = [
    {
      ...
      description:
        "Jaydeep Industries was established in Surat, Gujarat as manufacturers of SWASTIK brand Twin Wire Healds. There was a strict commitment to product quality and customer service. What started as a small company with limited machinery and labour, escalated to become a trusted name in the weaving manufacturing industry for making highly reliable machinery accessories.",
    },
    {
      year: "1983—1999",
      title: "INNOVATION",
      subtitle: "Material Expansion",
      description:
        "Started the manufacturing of Metal Reeds for weaving machines and introduced Nickle Plating to Wire Healds for better durability and strength. The Reeds expanded the Company's client base with its excellent standard. The Nickel Plating toughened the Wire Healds, thus showing Jaydeep's willingness to innovate and evolve to meet a certain benchmark of product quality.",
    },
    {
      year: "2000—2010",
      title: "EXPANSION",
      subtitle: "Export Beginnings",
      description:
        "This era saw a boost in sales due to the commencement of exports. The company won 4 Southern Gujarat Chamber of Commerce and Industry Export Awards. Still operating on the foundation of grade A product quality and customer service, Jaydeep Industries put itself on the global map.",
    },
    {
      year: "2011—PRESENT",
      title: "LEADERSHIP",
      ...
      description:
        "Jaydeep Industries became a part of various textile exhibitions and solidified its name in the global market. Today, the company has been awarded multiple National Awards for Export Excellence and Western Region Export Awards by EEPC India. These accolades are a reflection of our sustained performance, international quality standards and contribution to India's export growth in the engineering and textile components segment.",
    },
  ];
